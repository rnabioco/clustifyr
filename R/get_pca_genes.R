#' Returns a list of genes ("features") based on the top loadings of principal components formed from the bulk expression data set
#'
#' @param sc_avg_expr Expression data frame; rownames=genes, colnames=single cell cluster name, values=average single cell expression (log transformed).
