...
Alternatively, `clustify` can take a clustered `seurat` object and assign identities.
...
Correspondingly, `clustify_lists` can also handle identity assignment of matrix or `seurat` object based on marker gene lists.
