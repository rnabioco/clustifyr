...
[![#downloads](`r paste0("https://img.shields.io/badge/%23%20downloads-", sum(st_all[[4]]), "-brightgreen")`)](https://bioconductor.org/packages/stats/bioc/clustifyr/clustifyr_stats.tab)
...
9. **Why is the default setting `per_cell = FALSE`?**
...
10. **Can I use multiple references in the same clustify run?**
...
11. **Does clustifyr work for spatial scRNA-seq data?**
...
12. **Can I pull out additional information on what gene signatures don't match the reference clusters?**
