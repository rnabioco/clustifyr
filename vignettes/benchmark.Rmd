...
using Tablua Muris (drop and facs samples) 12 shared tissues

comparing:

default clustify, using var.genes from downloaded seurat objects

clustify with M3Drop for feature selection

scmap-cluster

singleR without fine tuning (takes hours)

<img src="../../man/figures/test.png" align="center"/>
