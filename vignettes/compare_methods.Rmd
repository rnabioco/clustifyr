...
cor_mat <- run_cor(expr_mat = pbmc4k_matrix,
...
vargenes_cor_mat <- run_cor(expr_mat = pbmc4k_matrix,
               metadata = pbmc4k_meta,
               bulk_mat = pbmc_bulk_matrix,
               query_gene_list = pbmc4k_vargenes,
               cluster_col = "classified",
...
markers_cor_mat <- run_cor(expr_mat = pbmc4k_matrix,
               metadata = pbmc4k_meta,
               bulk_mat = pbmc_bulk_matrix,
...
m3drop_cor_mat <- run_cor(expr_mat = pbmc4k_matrix,
               metadata = pbmc4k_meta,
               bulk_mat = pbmc_bulk_matrix,
...
pca_cor_mat <- run_cor(expr_mat = pbmc4k_matrix,
               metadata = pbmc4k_meta,
               bulk_mat = pbmc_bulk_matrix,
